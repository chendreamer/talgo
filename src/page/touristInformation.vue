    ...
    <div>
        <el-container>
            ...
            <div class="filter-list clearfix container">
                ...
                <div class="hover next" v-show="currentChecked != filterData.length - 1"
            ...
            <div class="container page">
                <div class="page-left">
                    <div class="swiper" style="position: relative">
                        ...
                        <div class="swiper-button-prev" v-show="swiperInitStatus"></div>

                        <div class="swiper-button-next" v-show="swiperInitStatus"></div>
                    </div>
                </div>
                ...
                <div class="detile">
                    <div class="detile-content">
                        ...
                        <!-- <el-rate v-model="value" disabled show-score text-color="#000" :score-template="scoreTemplate"
                            id="rate"></el-rate> -->
                    </div>
...
export default {
    ...
    data: function () {
        return {
            ...
            filterData: [],
            currentChecked: 0,
            swiperIsIniting : true,//swiper是否正在初始化中
        };
    },
    mounted: function () {
        let that = this;
    ...
    computed: {
        ...
        // },
        swiperInitStatus : function(){
            return !this.swiperIsIniting;
        }
    },
};
</script>
