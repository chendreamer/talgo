<template>
  <div class="list-item">
    <!-- <router-link :to="hrefPath"> -->
    <router-link
      :to="{
        name: 'summary',
        params: { summaryType: summaryType, summaryID: summaryID },
      }"
    >
      <div class="image-cover" :style="{ backgroundImage: path }">
        <!-- <img :src="path" alt="Load error" :style="coverStyle"/>
        <div class="image">-->
      </div>
    </router-link>
    <router-link
    ...
    >
      <p class="item-txt ellipsis">{{ item_txt }}</p>
    </router-link>
  </div>
</template>
